...
//tilts head to a predetermined angle
// wsn,  2/2019
...
int main(int argc, char** argv) {
    ...
    trajectory_point.time_from_start = ros::Duration(1.0); //allow 2 sec for this move
    ...
    trajectory_point.time_from_start = ros::Duration(3.0); //allow 3 sec for this move
    des_trajectory.points.push_back(trajectory_point);
