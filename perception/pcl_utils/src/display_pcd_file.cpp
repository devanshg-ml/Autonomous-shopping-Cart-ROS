...
int main(int argc, char** argv) {
  ...
  std::cout << "Loaded "
   ...
   //publish the point cloud in a ROS-compatible message; here's a publisher:
    ros::Publisher pubCloud = nh.advertise<sensor_msgs::PointCloud2> ("/head_camera/depth_registered/points", 1);
    ...
    cout << "view in rviz; choose: topic= /head_camera/depth_registered/points; and fixed frame= head_camera_rgb_optical_frame" << endl; 
